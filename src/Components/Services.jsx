...
const Services = () => {
    return (
        <section className="section service bg-black-10 text-center" aria-label="service" style={{ height: '1000px',  }}>
                        ...
                        <div className="service-card">
                            <a href="#" className="has-before hover:shine">
                                <div className="card-banner img-holder" style={{ '--width': 285, '--height': 336 }}>
                                    <img src={service1} width="285" height="336" loading="lazy" alt="Breakfast" className="img-cover" />
                                </div>
                            </a>data-
